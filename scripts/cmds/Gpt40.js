...
module.exports = {
  config: {
    name: "gpt4o",
    aliases: ["4o", "gpt4oai", "gpt_4o"],
    version: "1.0",
    author: "Redwan (Xe Mo)",
    countDown: 3,
    role: 0,
    shortDescription: "Chat with GPT-4o",
    longDescription: "Conversational AI powered by GPT-4o model.",
    category: "AI",
  ...
  async callAI(uid, msg, envGlobal) {
    ...
    const apiUrl = `${baseUrl}/api/gpt4o?uid=${uid}&msg=${encodeURIComponent(msg)}`;
  ...
  onStart: async function ({ api, event, args, envGlobal }) {
    ...
    try {
      ...
      api.unsendMessage(thinking.messageID);
      api.sendMessage("GPT-4o service is currently unavailable.", event.threadID);
    }
  },
